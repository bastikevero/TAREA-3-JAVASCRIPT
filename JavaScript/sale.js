 ...
 * getElementById("") es un método para recuperar el elemento HTML con id establecido en ("").
 *  Por ultimo la página web que se muestra en la ventana es document .
 * Los elementos recuperados con getElementById("") también pueden tener sólo los valores de sus atributos extraídos uniendo los puntos.
 */
